...
|4.|反射態 (Reflexive Voice)|ṇ|主語が動作を行い、その動作が主語自身に意図的に反射する。|
|5.|使役能動態 (Causative Active)|f|主語が、別の対象に能動的に動作を行わせる。|
|6.|使役中動態 (Causative Middle)|s|主語が、別の対象に動作を行わせるが、その行為が別の対象自身に影響する（仕向ける）。|
|7.|使役受動態 (Causative Passive)|x|主語が、別の対象に動作を行わせられる（他者からの強制）。|
|8.|使役反射態 (Causative Reflexive)|ṣ|主語が、別の対象に自分自身に関わる動作を行わせる（自己への強制）。|
