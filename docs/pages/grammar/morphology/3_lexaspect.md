...
|結果状態|-ul|ṭhakul|見えている状態である|
|瞬間状態|-is|ṭhakis|一瞬見える|
|確定状態|-ot|ṭhakot|確実に見える、見えていると確定する|
|継続活動|-af|ṭhakaf|活動として見る、観察する、眺める|
|達成活動|-in|ṭhakin|見て理解する、発見する|
|瞬間行為|-ep|ṭhakep|一瞬見る、ちらっと見る|
