...
layout: page
title: "因格と刺激格"
permalink: /misk/causal-stimulative/
---

# 因格と刺激格

**因格（Causal Case）と刺激格（Stimulative Case）は、どちらも「～によって」という原因を表すけれど、「引き起こす結果の質」**において決定的な違いがあるわ。
...
原因の質: より**抽象的、論理的、あるいは行動の動機となる「理由」や「根拠」**を表すわ。意図的な行動の理由や、ある状態に至った論理的な背景を示すの。

結果の質: 行為、現象、状態変化の**論理的な「帰結」**や、抽象的な結果を引き起こす。直接的な感覚や感情に作用するわけではないわ。
...
原因の質: **感情や感覚、認識などを直接的かつ具体的に「引き起こす」**要因を表すわ。五感に訴えたり、心に直接作用したりする性質があるの。

結果の質: 必ず**経験者格**の項に、**感情や感覚といった「刺激」**を誘発するわ。物理的な状態変化を引き起こすわけではないの。
